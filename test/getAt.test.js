...
describe('getAt', () => {
  ...
  it('Should throw an exception if input is undefined or null', () => {
    expect(() => getAt(undefined, 0)).toThrowError(
      'Cannot perform getAt on undefined'
    );
    expect(() => getAt(null, 0)).toThrowError('Cannot perform getAt on null');
  });
  it('Should throw an exception if input is non iterable base type', () => {
    expect(() => getAt(5, 0)).toThrowError('Cannot perform getAt on input');
  });
